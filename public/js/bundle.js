      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'FAILED successfully!');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            (0, _alert.showAlert)('error', 'Cannot log out! Please try again!');
...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    marker.className = 'marker'; // Add marker
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extend bound to include current loc
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'data' ? 'http://localhost:8080/api/v1/users/update' : 'http://localhost:8080/api/v1/users/updatePassword';
            console.log(data);
            _context.next = 5;
            return (0, _axios.default)({
              method: 'PATCH',
          ...
          case 5:
            res = _context.sent;
            if (res.data.status === 'success') (0, _alert.showAlert)('success', "".concat(type, " updated successfully"));
...
var stripe = Stripe('pk_test_1BZdSgjlzgnamBA1nmyWEVvY00e7hj6mmL');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.get("http://localhost:8080/api/v1/bookings/checkout-session/".concat(tourId));
...
var nameSpan = document.getElementById('name-header');
var userPhoto = document.getElementById('photo-preview');
var userPhotoHeader = document.getElementById('photo-header');
...
if (loginForm) loginForm.addEventListener('submit', function (evt) {
  evt.preventDefault();
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            if (img) {
              userPhoto.src = "img/users/".concat(img.name);
              userPhotoHeader.src = "img/users/".concat(img.name);
            }
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "13616" + '/');
